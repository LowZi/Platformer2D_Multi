...
public class ServerChoiceState extends BasicGameState {
	...
	//TextField
	ip = new TextField(container, container.getDefaultFont(), WindowGame.BASE_WINDOW_WIDTH / 2 - connecterImage.getWidth() / 2, 300, connecterImage.getWidth(), connecterImage.getHeight() );
